...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, ActivityIndicator, Modal, SafeAreaView, Dimensions, RefreshControl, Alert } from 'react-native';
      ...
      >
        ...
        >
          <View style={styles.typeBadge}>
             <Ionicons name="rocket-outline" size={14} color={currentTheme.secondary} />
        ...
        <View style={[styles.phaseCard, { borderColor: currentTheme.secondary }]}>
        ...
        <View style={[styles.sopSection, { borderColor: currentTheme.secondary }]}>
          <View style={styles.sopHeader}>
             <Ionicons name="bulb-outline" size={20} color={currentTheme.secondary} />
             <Text style={[styles.sopTitle, { color: currentTheme.primary }]}>Coach's Briefing</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  sopTitle: { fontSize: 15, fontWeight: '700' },
  sopText: { fontSize: 14, color: theme.colors.textSecondary, lineHeight: 22 },
